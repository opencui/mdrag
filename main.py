...
# curl -v -d 'fileType=url%2Btext' -d 'fileData=https://raw.githubusercontent.com/framely/actions-feishu-bot-hook/main/action.yaml'   http://127.0.0.1:8080/upload-file
